...
> Rapid check tls version support for a domain

[![PyPI version](https://badge.fury.io/py/rapid-tls-version.svg)](https://pypi.org/project/rapid-tls-version/)
...
```bash
pip install rapid-tls-version
```

## Quick Start

```python
from rapid_tls_version import version
...
from rapid_tls_version import batch
